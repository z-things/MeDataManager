            ...
            async.waterfall([
                    ...
                    function (device, innerCallback) {
                        ...
                        if (util.isNullOrUndefined(device.extra.preItems)) {
                            ...
                            var preData = JSON.parse(JSON.stringify(preData));
                            ...
                            if ("040B08040004" === curData.type) {
                                ...
                                curData.data["power"] = curData.data["effectiveVolt"] * curData.data["effectiveCurrent"] / 100;
                                ...
                                delete curData.data.effectiveVolt;
                                delete curData.data.effectiveCurrent;
                            }
                            else if ("040B01000004" === curData.type) {
                                curData.data["totalEnergy"] -= preData["totalEnergy"];
                            }
                            else if ("040B01000005" === curData.type) {
                                curData.data["eDisChargeTotal"] -= preData["eDisChargeTotal"];
                                curData.data["eChargeTotal"] -= preData["eChargeTotal"];
                                curData.data["eToGridTotal"] -= preData["eToGridTotal"];
                            }
                        }
                        var msg = {
                            devices: self.configurator.getConfRandom("services.device_manager"),
