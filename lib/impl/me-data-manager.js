            ...
            async.waterfall([
                    ...
                    function (device, innerCallback) {
                        ...
                        if (util.isNullOrUndefined(device.extra.preItems)) {
                            ...
                            if ("050608070001" === dataRecord.type) {
                                dataRecord.data["dis_temp"] = curData["dis_temp"];
                            }
                                ...
                                dataRecord.data["power"] = curData["effectiveVolt"] * curData["effectiveCurrent"] / 100;
                                if (17 === dataRecord.data["direct"]) {
                                    dataRecord.data["power"] = 0 - dataRecord.data["power"];
                                }
                                dataRecord.data["toGrid"] = curData["toGrid"] - preData["toGrid"];
                                dataRecord.data["toUser"] = curData["toUser"] - preData["toUser"];
                                delete dataRecord.data.direct;
                                delete dataRecord.data.effectiveVolt;
                                delete dataRecord.data.effectiveCurrent;
                            }
